...
import io.bettergram.telegram.ui.CacheControlActivity;
import io.bettergram.telegram.ui.Cells.AccountSelectCell;
import io.bettergram.telegram.ui.Cells.RadioColorCell;
import io.bettergram.telegram.ui.Cells.TextColorCell;
import io.bettergram.telegram.ui.LaunchActivity;
import io.bettergram.telegram.ui.ProfileNotificationsActivity;
import io.bettergram.telegram.ui.ReportOtherActivity;
...
public class AlertsCreator {
    ...
    public static AlertDialog showSecretLocationAlert(Context context, int currentAccount, final Runnable onSelectRunnable, boolean inChat) {
        ...
        if ((providers & 1) != 0) {
            arrayList.add(LocaleController.getString("MapPreviewProviderTelegram", R.string.MapPreviewProviderBettergram));
        }
        if ((providers & 2) != 0) {
